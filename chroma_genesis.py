...
for chapter in genesis['chapters']:
    ...
    for verse in chapter['verses']:
        ...
        genesis_metadata.append({'chapter': chapter['chapter'], 'verse': verse['verse']})
...
queries = ["God", "God Creates", "Children made in the image of God", "God is love", "God is angry", "How long do people live?"]
...
for query in queries:
    ...
    for doc, metadata, distance in zip(results['documents'][0], results['metadatas'][0], results['distances'][0]):
        print(f"- Chapter {metadata['chapter']}, Verse {metadata['verse']} ({distance:.2f}): {doc}")
        print()
    print()